...
<div class="page-wrapper">
    <div class="container-fluid">
        <h4 class="module-title">汇总报表做成(实实对账)</h4>
        <a class="module-close" href="${pageContext.request.contextPath}/index.do">X</a>
        <form class="form-search" id="form" name="form"  method="post" action="${pageContext.request.contextPath}/sumReportyEntityToEntity/exportExcel.do">
        	 <div class="form-block">
	            <label>报表种类</label>
	            <div class="form-group">
		            <select class="form-control" id="reportType" name="reportType">
		                <option value="银行315账户汇总信息核对表">银行315账户汇总信息核对表</option>
		                <option value="银行140账户汇总信息核对表">银行140账户汇总信息核对表</option>
			        </select>
		        </div>
		     </div>
	         <div class="form-block">
