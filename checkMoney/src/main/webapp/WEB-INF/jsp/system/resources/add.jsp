...
<link href="${ctx}/css/system/resources/add.css" rel="stylesheet">
...
<body>
	...
	action="${pageContext.request.contextPath}/resources/addEntity.do">
	<div class="container-fluid ">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control checkacc"
						placeholder="请输入优先级别" name="resFormMap.level" id="level">
				</div>
			</div>
		</div>
