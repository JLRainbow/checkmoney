		...
		<div class="container-fluid ">
			<div class="form-group">
		    	...
		    	<div class="col-sm-9">
					...
					<input type="text" id="channel_name" value="${channelManagementFormMap.channel_name}"   class="form-control"
		   	...
		   	<div class="form-group">
		    	...
		    	<div class="col-sm-9">
					<input type="text" id="channel_id" value="${channelManagementFormMap.channel_id}"   class="form-control"
					name="channelManagementFormMap.channel_id">
					<span id="isExist"></span>
		    	</div>
		   	</div>
		   	<div class="form-group">
		    	...
		    	<div class="col-sm-9">
		     		<select id="channel_type"  name="channelManagementFormMap.channel_type" class="form-control">
		    ...
		    <div class="form-group">
			    ...
			    <div class="col-sm-9">
			     	<select id="data_type"  name="channelManagementFormMap.data_type"  class="form-control">
